...
public class OFFactoryVer13 implements OFFactory {
    ...
    public OFCalientPortStatus.Builder buildCalientPortStatus() {
        return new OFCalientPortStatusVer13.Builder().setXid(nextXid());
    }
    ...
    public OFExpExtAdidSonet.Builder buildExpExtAdidSonet() {
        return new OFExpExtAdidSonetVer13.Builder();
    }
    public OFExpExtAdidSonet expExtAdidSonet(int type, OFBitMask128 id) {
    ...
    public OFExpPort.Builder buildExpPort() {
        return new OFExpPortVer13.Builder();
    }

    public OFExpPortAdidOtn.Builder buildExpPortAdidOtn() {
        return new OFExpPortAdidOtnVer13.Builder();
    }

    public OFExpPortAdjacency.Builder buildExpPortAdjacency() {
        return new OFExpPortAdjacencyVer13.Builder();
    }

    public OFExpPortAdjacencyId.Builder buildExpPortAdjacencyId() {
        return new OFExpPortAdjacencyIdVer13.Builder();
    }
    public OFExpPortAdjacencyId expPortAdjacencyId(List<OFExpExtAdId> adId) {
        return new OFExpPortAdjacencyIdVer13(
                adId
                    );
    }

    public OFExpPortAdjacencyReply.Builder buildExpPortAdjacencyReply() {
        return new OFExpPortAdjacencyReplyVer13.Builder().setXid(nextXid());
    }

    public OFExpPortAdjacencyRequest.Builder buildExpPortAdjacencyRequest() {
        return new OFExpPortAdjacencyRequestVer13.Builder().setXid(nextXid());
    }
    public OFExpPortAdjacencyRequest expPortAdjacencyRequest(Set<OFStatsRequestFlags> flags) {
        return new OFExpPortAdjacencyRequestVer13(
                nextXid(),
                      flags
                    );
    }

    public OFExpPortDesPropHeader expPortDesPropHeader() {
        return OFExpPortDesPropHeaderVer13.INSTANCE;
    }

    public OFExpPortDescPropOpticalTransport.Builder buildExpPortDescPropOpticalTransport() {
        return new OFExpPortDescPropOpticalTransportVer13.Builder();
    }

    public OFExpPortDescReply.Builder buildExpPortDescReply() {
        return new OFExpPortDescReplyVer13.Builder().setXid(nextXid());
    }

    public OFExpPortDescRequest.Builder buildExpPortDescRequest() {
        return new OFExpPortDescRequestVer13.Builder().setXid(nextXid());
    }
    public OFExpPortDescRequest expPortDescRequest(Set<OFStatsRequestFlags> flags) {
        return new OFExpPortDescRequestVer13(
                nextXid(),
                      flags
                    );
    }

    public OFExpPortOpticalTransportLayerEntry.Builder buildExpPortOpticalTransportLayerEntry() {
        return new OFExpPortOpticalTransportLayerEntryVer13.Builder();
    }

    public OFExpPortOpticalTransportLayerStack.Builder buildExpPortOpticalTransportLayerStack() {
        return new OFExpPortOpticalTransportLayerStackVer13.Builder();
    }
    public OFExpPortOpticalTransportLayerStack expPortOpticalTransportLayerStack(List<OFExpPortOpticalTransportLayerEntry> value) {
    ...
    public OFOduSigIdT.Builder buildOduSigIdT() {
        return new OFOduSigIdTVer13.Builder();
    }
    public OFOduSigIdT oduSigIdT(int tpn, byte[] tsmap) {
    ...
    public OFOplinkChannelPower.Builder buildOplinkChannelPower() {
        return new OFOplinkChannelPowerVer13.Builder();
    }

    public OFOplinkChannelPowerReply.Builder buildOplinkChannelPowerReply() {
        return new OFOplinkChannelPowerReplyVer13.Builder().setXid(nextXid());
    }

    public OFOplinkChannelPowerRequest.Builder buildOplinkChannelPowerRequest() {
        return new OFOplinkChannelPowerRequestVer13.Builder().setXid(nextXid());
    }
    public OFOplinkChannelPowerRequest oplinkChannelPowerRequest(Set<OFStatsRequestFlags> flags) {
        return new OFOplinkChannelPowerRequestVer13(
                nextXid(),
                      flags
                    );
    }

    public OFOplinkPortPower.Builder buildOplinkPortPower() {
        return new OFOplinkPortPowerVer13.Builder();
    }
    public OFOplinkPortPower oplinkPortPower(int port, int powerValue) {
    ...
    public OFOplinkPortPowerReply.Builder buildOplinkPortPowerReply() {
        return new OFOplinkPortPowerReplyVer13.Builder().setXid(nextXid());
    }

    public OFOplinkPortPowerRequest.Builder buildOplinkPortPowerRequest() {
        return new OFOplinkPortPowerRequestVer13.Builder().setXid(nextXid());
    }
    public OFOplinkPortPowerRequest oplinkPortPowerRequest(Set<OFStatsRequestFlags> flags) {
        return new OFOplinkPortPowerRequestVer13(
                nextXid(),
                      flags
                    );
    }

    public OFOplinkPortPowerSet.Builder buildOplinkPortPowerSet() {
        return new OFOplinkPortPowerSetVer13.Builder().setXid(nextXid());
    }

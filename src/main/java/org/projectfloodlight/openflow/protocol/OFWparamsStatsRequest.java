...
public interface OFWparamsStatsRequest extends OFObject, OFStatsRequest<OFWparamsStatsReply>, OFRequest<OFWparamsStatsReply> {
    ...
    public interface Builder extends OFStatsRequest.Builder<OFWparamsStatsReply> {
        OFWparamsStatsRequest build();
        OFVersion getVersion();
        OFType getType();
        long getXid();
